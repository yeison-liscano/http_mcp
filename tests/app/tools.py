...
from tests.app.context import Context  # noqa: TC001
...
async def get_weather(args: Arguments[GetWeatherInput, Context]) -> GetWeatherOutput:
...
async def get_time(args: Arguments[GetTimeInput, Context]) -> GetTimeOutput:
...
async def tool_that_access_request(
    args: Arguments[ToolThatAccessRequest, Context],
...
async def get_called_tools(
    args: Arguments[GetCalledToolsInput, Context],
